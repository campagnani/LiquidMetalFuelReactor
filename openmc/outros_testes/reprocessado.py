...
combustivel.add_nuclide('Th232', 1700, percent_type='ao')
combustivel.add_nuclide('Pu239', 56.62, percent_type='ao')

#combustivel.add_nuclide('Pu238', 1.26, percent_type='ao')
#combustivel.add_nuclide('Pu239', 56.62, percent_type='ao')
#combustivel.add_nuclide('Pu240', 23.18, percent_type='ao')
#combustivel.add_nuclide('Am241', 8.52, percent_type='ao')
#combustivel.add_nuclide('Pu241', 5.69, percent_type='ao')
#combustivel.add_nuclide('Pu242', 4.73, percent_type='ao')
...
ax1.plot(flux_spec_fuel1_energy, flux_spec_fuel1_mean, color='xkcd:blue', linestyle='-', linewidth=1,marker='^', markersize=5, label='Americio')
...
pu238 = openmc.data.IncidentNeutron.from_hdf5("/SSD3/nuclear-data/endfb-viii.0-hdf5/neutron/Pu238.h5")
energies = pu238.energy['294K']
total_xs = pu238[18].xs['294K'](energies)
ax2.plot(energies, total_xs, color='xkcd:red', linestyle='-', linewidth=1, label='Pu238')
...
pu240 = openmc.data.IncidentNeutron.from_hdf5("/SSD3/nuclear-data/endfb-viii.0-hdf5/neutron/Pu240.h5")
energies = pu240.energy['294K']
total_xs = pu240[18].xs['294K'](energies)
ax2.plot(energies, total_xs, color='xkcd:red', linestyle='-', linewidth=1, label='Pu240')


pu241 = openmc.data.IncidentNeutron.from_hdf5("/SSD3/nuclear-data/endfb-viii.0-hdf5/neutron/Pu241.h5")
energies = pu241.energy['294K']
total_xs = pu241[18].xs['294K'](energies)
ax2.plot(energies, total_xs, color='xkcd:red', linestyle='-', linewidth=1, label='Pu241')


pu242 = openmc.data.IncidentNeutron.from_hdf5("/SSD3/nuclear-data/endfb-viii.0-hdf5/neutron/Pu242.h5")
energies = pu242.energy['294K']
total_xs = pu242[18].xs['294K'](energies)
ax2.plot(energies, total_xs, color='xkcd:red', linestyle='-', linewidth=1, label='Pu242')


am241 = openmc.data.IncidentNeutron.from_hdf5("/SSD3/nuclear-data/endfb-viii.0-hdf5/neutron/Am241.h5")
energies = am241.energy['294K']
total_xs = am241[18].xs['294K'](energies)
ax2.plot(energies, total_xs, color='xkcd:green', linestyle='-', linewidth=1, label='Am241')
